        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileStatId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ProfileStats_ProfileStatId",
                        column: x => x.ProfileStatId,
                        principalTable: "ProfileStats",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserQuestionStats_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Temel Yeterlilik Testi", new DateTime(2025, 6, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "TYT" },
                    { 2, "Alan Yeterlilik Testi", new DateTime(2025, 6, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "AYT" },
                    { 3, "Kamu Personeli Seçme Sınavı", new DateTime(2025, 6, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "KPSS" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ProfileStatId",
                table: "AspNetUsers",
                column: "ProfileStatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuestionStats_AppUserId",
